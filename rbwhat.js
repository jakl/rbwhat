...
(function() {
  var allowedAge, client, colorName, config, configPath, extend, formatDate, formatHeading, fs, loadExistingConfig, loadOptions, main, moment, needsReview, printActiveRequest, querystringify, rbapi, rbapiReviewRequests, rbapiReviews, syncConfig, tooOld;
